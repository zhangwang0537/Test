...
CPP_ENGINE_C_API uintptr_t engine_feval_with_completion(const uint64_t matlabHandle, const char* function, size_t nlhs, bool scalar, matlab::data::impl::ArrayImpl** args, size_t nrhs, void(*suc)(void*, size_t, bool, matlab::data::impl::ArrayImpl**), void(*exc)(void*, size_t, bool, size_t, const void*), void* p, void* output, void* error, void(*write)(void*, const char16_t*, size_t), void(*deleter)(void*));
CPP_ENGINE_C_API void engine_eval_with_completion(const uint64_t matlabHandle, const char16_t* statement, void(*suc)(void*), void(*exc)(void*, size_t, const void*), void* p, void* output, void* error, void(*write)(void*, const char16_t*, size_t), void(*deleter)(void*), uintptr_t** handles);
...
CPP_ENGINE_C_API void engine_utf8_to_utf16(const char* utf8, char16_t** utf16, size_t* errType);

CPP_ENGINE_C_API void engine_utf16_to_utf8(const char16_t* utf16, char** utf8, size_t* errType);

CPP_ENGINE_C_API void engine_destroy_utf8(char* utf8);

CPP_ENGINE_C_API void engine_destroy_utf16(char16_t* utf16);
