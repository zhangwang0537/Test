...
#include "detail/char_array_interface.hpp"
        ...
        class CharArray : public TypedArray<CHAR16_T>
        {
          public:
            ...
            String toUTF16() const MW_NOEXCEPT 
            {
                ...
                size_t strLen = 0;
                char_array_get_string(detail::Access::getImpl<impl::ArrayImpl>(*this), &str, &strLen);
          ...
          private:
            ...
            CharArray(matlab::data::impl::ArrayImpl* impl) MW_NOEXCEPT :
