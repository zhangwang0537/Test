        ...
        class StructArray : public TypedArray<Struct> {
          public:
            ...
            Range<ForwardIterator, MATLABFieldIdentifier const> getFieldNames() const MW_NOEXCEPT {
                return Range<ForwardIterator, MATLABFieldIdentifier const>(detail::Access::createObj<ForwardIterator<MATLABFieldIdentifier const>>(struct_array_begin_id(detail::Access::getImpl<impl::ArrayImpl>(*this))),
                                                                           detail::Access::createObj<ForwardIterator<MATLABFieldIdentifier const>>(struct_array_end_id(detail::Access::getImpl<impl::ArrayImpl>(*this))));
            }
            ...
            size_t getNumberOfFields() const MW_NOEXCEPT {
                return struct_array_get_num_fields(detail::Access::getImpl<impl::ArrayImpl>(*this));
            }
          ...
          private:
            ...
            StructArray(matlab::data::impl::ArrayImpl* impl) MW_NOEXCEPT :
