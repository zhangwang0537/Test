...
#include "sharedxcp/utils/cnblib.hpp"
...
XTLAPI   int  xcpTlSend(HTL, xpcNBPtr buffer);

XTLAPI   int  xcpTlGetProtocolOffset(void);

XTLAPI   HTL  xcpTlAttach(char *tag_s, char* tag_t, real_T* t, XCPUpstreamIface xi);
XTLAPI   int  xcpTlDetach(HTL);
